...
export default <LangMap>{
  ...
  "上传后重命名": "Rename on upload",
  "开启后，服务端会使用 年月日时分秒 命名；只有重名时才追加随机短串": "When enabled, the server names files with year-month-day-hour-minute-second and only appends a short random suffix on conflicts",
  "支持": "Support",
  "捐赠": "Donate",
  ...
  "压缩后再上传": "Compress before upload",
  "压缩后再上传；关闭时直接上传原图": "Compress before upload; when disabled, upload the original image directly",
  "上传速度优化 - 压缩质量": "Upload speed optimization - Compression quality",
  "压缩后再上传 - 压缩质量": "Compress before upload - Compression quality",
  ...
  "压缩后再上传 - 最大宽度": "Compress before upload - Maximum width",
  ...
  "压缩后再上传 - 最大高度": "Compress before upload - Maximum height",
